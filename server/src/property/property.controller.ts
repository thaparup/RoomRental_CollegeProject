...
export class PropertyController {
  ...
  @Get('room/image')
  getSingleImageForRoom(@GetCurrentUserId() userId: TokenUser) {
    return this.roomService.getSingleImageForRoom(+userId);
  }
  ...
  getSingleImageForHouse(
    ...
    return this.houseService.getSingleImageForHouse(parseInt(houseId), +userId);
  }
